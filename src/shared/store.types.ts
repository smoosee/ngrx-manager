...
import { StringToCase } from "./store.utils";
...
export type ServiceActions<S extends Service> = { [K in ServiceMethod<S>]: StoreAction<Uppercase<StringToCase<K, 'snake'>>, S, K> }[ServiceMethod<S>][];
